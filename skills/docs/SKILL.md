---
name: docs
description: Product thinking and documentation. Manages product specs, customer understanding, decisions, backlogs, and signals. Keeps docs in sync with code through periodic review.
---
...
issue を受け取ったとき:
- index.md → 製品の方向性を確認
- features.md → 現状の機能を把握
- backlogs/ → 分析済みの課題を確認
- decisions/ → 過去の判断を確認

判断をしたとき:
- decisions/ に新しい ADR を追加

コードが変わったとき:
- features.md, user-flows.md をコードと照合し、矛盾があれば部分的に更新する

ユーザーの声が来たとき:
- signals/ に記録
- 重要な課題は backlogs/ に分析を追加
